...
import {
  ...
  buildIceServers,
  getWebRTCConfig,
} from '../../../FRONTEND/src/services/webrtcConfig.js';
...
async function runTests() {
  ...
  {
    const hookPath = path.resolve(__dirname, '../../../FRONTEND/src/features/video-call/hooks/useWebRTC.js');
  ...
  {
    const configPath = path.resolve(__dirname, '../../../FRONTEND/src/services/webrtcConfig.js');
